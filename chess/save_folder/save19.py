...
def getBestMove(arr_char , player_color):
    ...
    for piece in arr_char:
        ...
        if piece.getColor() == player_color:
            continue
        valid_options = getValidPositions(piece.getArrMoveOptions() , piece , getKing(piece.getColor() , arr_char) , piece.getColor() , arr_char)
...
def main():
    ...
    while running:
        ...
        if (check_pressed_mouse(MOUSE_PRESSED) == "pressed"):
            print(check_pressed_mouse(MOUSE_PRESSED))
