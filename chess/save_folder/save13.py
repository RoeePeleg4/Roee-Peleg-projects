...
class Button():
    ...
    def __init__(self, middle_cordinate_for_placement = (0,0) , text = "text" , color = (255,255,255) , shape = "rectangle" , pixel_size = 100 , text_font = "Arial" , radius = None , width_spacing = 1.2 , height_spacing = 1.2 , text_spacing = 0.1):
        ...
        self.width = self.width_spacing  * text_width
        self.height = self.height_spacing  * text_height
    ...
    def showButton(self):
        ...
        text_width, text_height = self.text_font.size(self.text)
        #display the text
        draw_txt(self.text , self.text_font , (30,144,255) , self.middleCords[0] - (text_width / 2) , self.middleCords[1] - (text_height / 2))
        pygame.display.flip()
...
def main():
    ...
    #creation of buttons
    """"to split by \n ,  string_str.split("\n") returns an array"""
    sameComputerButton = Button((700,500) , "1v1 on the same computer" , (255,255,255) , "rectangle" , 30)
    buttons_list = []
