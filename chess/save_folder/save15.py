...
class Button():
    ...
    def __init__(self, middle_cordinate_for_placement = (0,0) , text = "text" , color = (255,255,255) , shape = "rectangle", pixel_size = 100 ,  lines_margin = 0 , text_font = "Arial" , radius = None , width_spacing = 1 , height_spacing = 1 , text_spacing = 0.1):
        ...
        print(lines_margin * (len(self.text_list) - 1))
...
def main():
    ...
    #creation of buttons
    """"to split by \n ,  string_str.split("\n") returns an array"""
    sameComputerButton = Button((700,200) , "1v1\non the same\ncomputer\nhello" , (255,255,255) , "rectangle" , 30 , 10)
    buttons_list = []
