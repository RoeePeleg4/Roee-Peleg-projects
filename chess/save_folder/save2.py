...
def getPlaces(piece , arr_char , king):
    ...
    """if (piece.getColor() == "white" and piece.getType() == "queen"):
        print (options_arr + eatable_arr)"""
...
def canMove(piece , arr_char , position , king_by_piece_color):
    ...
    if index == None:
        print("Index is None")
    for i in range(len(arr_char)):
        if arr_char[i].getType() == "queen" and arr_char[i].getColor() == "white":
            pass
